...
if [ "$(mount | sed -n '/secret/ s/^tmpfs on \(.*default.*\) type tmpfs.*$/\1\/namespace/p')" ]; then
  ...
  print_info "https://cloud.khulnasoft.com/pentesting-cloud/kubernetes-security/attacking-kubernetes-from-inside-a-pod"
...
if [ "$inContainer" ]; then
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation/docker-breakout"
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation/docker-breakout/docker-breakout-privilege-escalation/sensitive-mounts"
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation/docker-breakout/namespaces"
    ls -l /proc/self/ns/
    ...
    if echo "$containerType" | grep -qi "kubernetes"; then
        ...
        print_info "https://cloud.khulnasoft.com/pentesting-cloud/kubernetes-security/abusing-roles-clusterroles-in-kubernetes"
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation/docker-breakout/docker-breakout-privilege-escalation#capabilities-abuse-escape"
