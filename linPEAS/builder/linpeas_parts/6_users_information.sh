...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#users"
...
if [ "$MACPEAS" ];then
  ...
  print_info "https://book.khulnasoft.com/macos/macos-security-and-privilege-escalation#chainbreaker"
...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#reusing-sudo-tokens"
...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation/interesting-groups-linux-pe#pe-method-2"
