...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#script-binaries-in-path"
  echo $PATH | tr ":" "\n" | while read d; do
...
print_2title "Writable log files (logrotten) (limit 50)"
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#logrotate-exploitation"
