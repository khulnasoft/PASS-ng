...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#open-ports"
...
if [ $? -eq 124 ]; then #If 124, then timed out == It worked
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#sniffing"
