...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#kernel-exploits"
...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#sudo-version"
...
if (busctl list 2>/dev/null | grep -q com.ubuntu.USBCreator) || [ "$DEBUG" ]; then
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation/d-bus-enumeration-and-command-injection-privilege-escalation"
...
print_2title "PATH"
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#writable-path-abuses"
if ! [ "$IAMROOT" ]; then
...
if [ "$(command -v dmesg 2>/dev/null)" ] || [ "$DEBUG" ]; then
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#dmesg-signature-verification-failed"
