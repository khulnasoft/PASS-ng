...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  print_info "Check weird & unexpected proceses run by root: https://book.khulnasoft.com/linux-hardening/privilege-escalation#processes"
  ...
  if [ "$NOUSEPS" ]; then
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#processes"
...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#credentials-from-process-memory"
...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  if ! [ "$FAST" ] && ! [ "$SUPERFAST" ]; then
    ...
    print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#frequent-cron-jobs"
    temp_file=$(mktemp)
...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#scheduled-cron-jobs"
...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  if [ "$MACPEAS" ]; then
    ...
    print_info "https://book.khulnasoft.com/macos/macos-security-and-privilege-escalation#launchd"
    ...
    print_info "https://book.khulnasoft.com/macos/macos-security-and-privilege-escalation#startup-items"
    ls -l /Library/StartupItems/ /System/Library/StartupItems/ 2>/dev/null
    echo ""

    print_2title "Login Items"
    print_info "https://book.khulnasoft.com/macos/macos-security-and-privilege-escalation#login-items"
    ...
    print_info "https://book.khulnasoft.com/macos/macos-security-and-privilege-escalation#emond"
...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#systemd-path-relative-paths"
...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#services"
...
if ! [ "$SEARCH_IN_FOLDER" ]; then
  ...
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#timers"
...
if ! [ "$IAMROOT" ]; then
  ...
  print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#sockets"
...
print_info "https://book.khulnasoft.com/linux-hardening/privilege-escalation#d-bus"
