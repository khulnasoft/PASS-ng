...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#kernel-exploits
systeminfo
ECHO.
CALL :T_Progress 2
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#basic-uac-bypass-full-file-system-access
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#software
ECHO.
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#remote-desktop-credential-manager
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#wsus
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#running-processes
tasklist /SVC
ECHO.
CALL :T_Progress 2
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#run-at-startup
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#alwaysinstallelevated
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#users-and-groups
ECHO.
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#services
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#dll-hijacking
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#windows-vault
cmdkey /list
ECHO.
CALL :T_Progress 2
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#dpapi
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#appcmd.exe
...
ECHO.   [?] https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#credentials-inside-files
