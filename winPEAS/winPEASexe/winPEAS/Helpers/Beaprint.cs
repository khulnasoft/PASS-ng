...
namespace winPEAS.Helpers
{
    ...
    {0}((((((((({1}#################################{0})(((((((((
       ...
       /---------------------------------------------------------------------------------\
       |                             {1}Do you like PASS?{0}                                  |
       |---------------------------------------------------------------------------------| 
       |         {3}Get the latest version{0}    :     {2}https://github.com/sponsors/khulnasoft{0} |
       |         {3}Follow on Twitter{0}         :     {2}@khulnasoft{0}                        |
...
", GREEN, BLUE, RED, YELLOW) + NOCOLOR);
        ...
        public static void PrintInit()
        {
            ...
            Console.WriteLine(YELLOW + "  WinPEAS-ng" + NOCOLOR + YELLOW + " by @khulnasoft" + NOCOLOR);

            PrintMarketingBanner();

            PrintLegend();
            Console.WriteLine();
            Console.WriteLine(BLUE + " You can find a Windows local PE Checklist here: " + YELLOW + "https://book.khulnasoft.com/windows-hardening/checklist-windows-privilege-escalation");
        }
