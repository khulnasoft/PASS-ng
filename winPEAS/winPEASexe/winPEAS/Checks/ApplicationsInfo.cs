    ...
    internal class ApplicationsInfo : ISystemCheck
    {
        ...
        void PrintInstalledApps()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#software", "Check if you can modify installed software");
        ...
        private static void PrintAutoRuns()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation/privilege-escalation-with-autorun-binaries", "Check if you can modify other users AutoRuns binaries (Note that is normal that you can modify HKCU registry and binaries indicated there)");
        ...
        void PrintScheduled()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation/privilege-escalation-with-autorun-binaries", "Check if you can modify other users scheduled binaries");
        ...
        void PrintDeviceDrivers()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#vulnerable-drivers", "Check 3rd party drivers for known vulnerabilities/rootkits.");
