    ...
    internal class ProcessInfo : ISystemCheck
    {
        ...
        void PrintInterestingProcesses()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#running-processes", "Check if any interesting processes for memory dump or if you could overwrite some binary running");
        ...
        void PrintVulnLeakedHandlers()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation/leaked-handle-exploitation");
