       ...
       */
        ...
        void PrintCU()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#users-and-groups", "Check if you have some admin equivalent privileges");
        ...
        void PrintTokenP()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#token-manipulation", "Check if you can escalate privilege using some enabled token");
