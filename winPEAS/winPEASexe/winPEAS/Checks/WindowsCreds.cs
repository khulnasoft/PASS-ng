    ...
    internal class WindowsCreds : ISystemCheck
    {
        ...
        private static void PrintVaultCreds()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#credentials-manager-windows-vault");
        ...
        private static void PrintDPAPIMasterKeys()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#dpapi");
        ...
        private static void PrintRCManFiles()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#remote-desktop-credential-manager",
        ...
        private static void PrintKerberosTickets()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/pentesting/pentesting-kerberos-88");
        ...
        private static void PrintAppCmd()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#appcmd.exe");
        ...
        private static void PrintSCClient()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#scclient-sccm");
