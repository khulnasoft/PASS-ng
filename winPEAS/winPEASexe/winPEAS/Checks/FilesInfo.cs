    ...
    internal class FilesInfo : ISystemCheck
    {
        ...
        void PrintCloudCreds()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#credentials-inside-files");
        ...
        void PrintPossCredsRegs()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#inside-the-registry");
