    ...
    internal class ServicesInfo : ISystemCheck
    {
        ...
        void PrintInterestingServices()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#services", "Check if you can overwrite some service binary or perform a DLL hijacking, also check for unquoted paths");
        ...
        void PrintModifiableServices()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#services", "Check if you can modify any service");
        ...
        void PrintWritableRegServices()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#services-registry-permissions", "Check if you can modify the registry of a service");
        ...
        void PrintPathDllHijacking()
        {
            try
            {
                ...
                Beaprint.LinkPrint("https://book.khulnasoft.com/windows-hardening/windows-local-privilege-escalation#dll-hijacking", "Check for DLL Hijacking in PATH folders");
