...
[![youtube](https://github.com/khulnasoft-lab/privilege-access-security-suite/raw/master/winPEAS/winPEASexe/images/screen.png)](https://youtu.be/66gOwXMnxRI)
...
winpeas.exe -linpeas=http://127.0.0.1/linpeas.sh #Execute also additional linpeas check (runs linpeas.sh in default WSL distribution) with custom linpeas.sh URL (if not provided, the default URL is: https://raw.githubusercontent.com/khulnasoft-lab/privilege-access-security-suite/master/linPEAS/linpeas.sh)
...
![](https://github.com/khulnasoft-lab/privilege-access-security-suite/raw/master/winPEAS/winPEASexe/images/colors.png)
...
![](https://raw.githubusercontent.com/khulnasoft-lab/privilege-access-security-suite/master/winPEAS/winPEASexe/images/dotfuscator.PNG)
...
- **Additional (slower) checks**
  - [x] LOLBAS search
  - [x] run **[linpeas.sh](https://raw.githubusercontent.com/khulnasoft-lab/privilege-access-security-suite/master/linPEAS/linpeas.sh)** in default WSL distribution
...
If you want to help with any of this, you can do it using **[github issues](https://github.com/khulnasoft-lab/privilege-access-security-suite/issues)** or you can submit a pull request.
